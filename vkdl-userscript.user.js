...
function main() {
  // Note, jQ replaces $ to avoid conflicts.
    ...
    jQ( ".soundList__item" ).each(function( i ) {
        ...
        if (jQ( ".soundList__item" ).hasClass( "vkdl-link-added" ) == true ) {
    //Do nothing, this space intentionally left blank
        ...
        var SongTitle = RawSongTitle.split(' ').join('+');
            ...
            jQ( '<a target="_blank" href="https://rawgit.com/Porco-Rosso/vkdl/master/index.html#' + SongTitle + '" class="sc-button-more sc-button sc-button-small sc-button-responsive" tabindex="0" title="Search on vkdl">Vkdl</a>' ).insertAfter( jQ(this).find(".sc-button-toolbar>.sc-button:last-child, .sc-button-group>.sc-button:last-child") );
...
//        jQ(".sc-button-search").css('background-image','url(data:image/svg+xml;base64,)')
        ...
        jQ( ".soundList__item" ).addClass("vkdl-link-added");
